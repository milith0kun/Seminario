...
Diseñar, implementar y evaluar un prototipo funcional de asistente educativo offline español--Quechua Collao basado en un modelo de lenguaje compacto con RAG local, orientado al apoyo de consultas curriculares en contextos de Educación Intercultural Bilingüe.
