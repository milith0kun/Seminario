...
El desarrollo tecnológico debe alinearse con los marcos normativos y pedagógicos vigentes. El Modelo de Servicio Educativo Intercultural Bilingüe (MSEIB) del Ministerio de Educación del Perú \citep{minedu2018} establece lineamientos para garantizar una educación pertinente a estudiantes de pueblos originarios, en concordancia con el Currículo Nacional de la Educación Básica \citep{minedu2016}. El MSEIB distingue escenarios de fortalecimiento lingüístico (donde el quechua es lengua materna y el español segunda lengua) y revitalización (donde el español es lengua materna). Esto exige que cualquier herramienta de asistencia educativa no sea un simple traductor bidireccional, sino un sistema capaz de alternar códigos, detectar el idioma predominante del estudiante y recuperar contenidos con pertinencia cultural e intercultural, apoyando directamente la labor del docente bilingüe.

\subsection{Matriz resumida de antecedentes}
Para consolidar la revisión precedente, la Tabla~\ref{tab:antecedentes} sintetiza los antecedentes empíricos y tecnológicos más directamente relacionados con el diseño del asistente, contrastando los objetivos, métodos, resultados clave y el aporte específico de cada trabajo a la presente investigación.
